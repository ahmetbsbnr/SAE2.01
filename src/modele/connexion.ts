...
//APIsql.sqlWeb.init("https://devweb.iutmetz.univ-lorraine.fr/~e26350u/psp/vue/","https://devweb.iutmetz.univ-lorraine.fr/~e26350u/IHM_API/")
...
APIsql.sqlWeb.init("https://devweb.iutmetz.univ-lorraine.fr/~e85650u/IHM/SAE201/squelette/vue/","https://devweb.iutmetz.univ-lorraine.fr/~e85650u/IHM/SAE201/squelette/PHP/IHM_API/")
...
class Connexion {
	...
	init():void {
		...
		APIsql.sqlWeb.bdOpen('devbdd.iutmetz.univ-lorraine.fr','3306','e85650u_SAE201', 'e85650u_appli','32408922', 'utf8');
	}
}
let connexion = new Connexion;
